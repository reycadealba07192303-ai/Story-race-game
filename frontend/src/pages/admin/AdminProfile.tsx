      ...
      <div className="db-profile-hero-banner" style={{
        ...
        <div className="db-profile-hero-inner">
          <div className="db-profile-hero-main">
            <div style={{ position: 'relative', cursor: 'pointer', flexShrink: 0 }} onClick={() => fileInputRef.current?.click()}>
              <div style={{
                ...
                {!currentAvatar && initials(user?.name || 'AD')}
              </div>
              <div style={{
            ...
            <div>
              <div className="db-profile-hero-name">{user?.name || 'Admin'}</div>
          ...
          <div className="db-profile-hero-stat">
            <div className="db-profile-hero-stat-label">System Admin</div>
            ...
            <div className="db-profile-save-row">
              <button
                ...
                style={{
                  ...
                  background: saving ? 'var(--db-hover)' : 'linear-gradient(135deg, #4F46E5, #7C3AED)',
        ...
        <div className="db-profile-sidebar">
          ...
          <div className="db-profile-card db-profile-card--padded">
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 16 }}>
              <div style={{ width: 44, height: 44, borderRadius: 14, background: 'linear-gradient(135deg, #EEF2FF, #E0E7FF)', color: '#4F46E5', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                <Shield size={22} />
              </div>
              <div style={{ flex: 1 }}>
          ...
          <div className="db-profile-card db-profile-card--padded">
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 20 }}>
              <div style={{ width: 44, height: 44, borderRadius: 14, background: 'linear-gradient(135deg, #EFF6FF, #DBEAFE)', color: '#3B82F6', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                <Activity size={22} />
              </div>
              <div style={{ flex: 1 }}>
            ...
            <div className="db-profile-heatmap">
              {heatmap.map((v, i) => (
                <div key={i} style={{
                  ...
                  background: v === 0 ? 'var(--db-hover)' : v === 1 ? 'rgba(59,130,246,0.25)' : v === 2 ? 'rgba(59,130,246,0.6)' : '#3B82F6',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 14, fontSize: 11, color: 'var(--db-muted)', fontWeight: 600, fontFamily: PROFILE_FONT, textTransform: 'uppercase', letterSpacing: 0.5 }}>
              <span>Less</span>
              {[0, 1, 2, 3].map(v => (
                <div key={v} style={{ width: 12, height: 12, borderRadius: 3, background: v === 0 ? 'var(--db-hover)' : v === 1 ? 'rgba(59,130,246,0.25)' : v === 2 ? 'rgba(59,130,246,0.6)' : '#3B82F6', border: v === 0 ? '1px solid var(--db-border)' : 'none' }} />
              ))}
              <span>More</span>
            </div>
          </div>
